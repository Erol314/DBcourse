...
\begin{document}
        ...
        \subsection*{Tasks:}
        \begin{itemize}
                \item Answer Questions at the end of Chapter 8;
                \item Solve ex. 1 - 8 at the end of Chapter 8.

                
        \end{itemize}
        \subsection*{Task Realization:}
        In Figure 1 we can see the result of old Querry from Lab 4 but now i inserted the result in a view.
        \begin{figure}[H]
                \centering
                \includegraphics[width=\textwidth]{img1a.png}
                \caption{Querry Ex1a}
        \end{figure}
        \vspace{0.5 cm}
        
        In Figure 1 we can see the result of another old Querry from Lab 4  inserted  in a view. Now it is created not with script.
        \begin{figure}[H]
                \centering
        ...
        In figure 3 I tried to modify a view but i gained an error because i used SCHEMABINDING and WITH CHECK OPTION. So it blocks any changes in initial tables.
        \begin{figure}[H]
                \centering
                \includegraphics[width = 0.7 \textwidth]{img3_4.png}
                \caption{Query ex 3 and 4}
        \end{figure}
        \vspace{0.5 cm}

        In figure 4 and 5 i used old Querry from lab 4 and rewrote them In CTE form 
        \begin{figure}[H]
                \centering
                \includegraphics[width=\textwidth]{img5a.png}
                \caption{Query ex 5a}
        \end{figure}
        \vspace{0.5 cm}
        ...
        \begin{figure}[H]
                \centering
                \includegraphics[width=\textwidth]{img5b.png}
                \caption{Query ex 5b}
        \end{figure}
        \vspace{0.5 cm}
        In figure 6 we can observe recursive traversing of the ordered graph
        \begin{figure}[H]
                \centering
        ...
        During This lab work i find out how to make views and why do i need them in real database.
...
SQL Server Management Studio 2017, Tutorials for Lab 8
